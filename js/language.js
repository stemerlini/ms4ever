...
const translations = {
    en: {
        ...
        faq1answer: `The ceremony will begin at <string> 19:00 </string>. Kindly arrive earlier, starting from 18:30.`,
        faq2: "Where is the dinner being held?",
        faq2answer: "Dinner will take place at <strong>20:30</strong>, following the ceremony and the cocktail hour.",
    ...
    it: {
        ...
        faq1answer: `La cerimonia inizierà alle <strong>19:00</strong>. Vi preghiamo di arrivare prima, entro le 18:30.`,
        faq2: "Dove si terrà la cena?",
        faq2answer: "La cena si terrà alle <strong>20:30</strong>, dopo la cerimonia e l'ora del cocktail.",
    ...
    el: {
        ...
        foodAndDrinksDescription: `
            - <strong>Τρίγωνα Πανοράματος:</strong> Το σήμα κατατεθέν γλυκό της Θεσσαλονίκης με κρέμα. <br>
        ...
        faq1answer: `Η τελετή θα ξεκινήσει στις <strong> 19:00 </strong>. Παρακαλούμε να φτάσετε νωρίτερα, από τις 18:30.`,
        faq2: "Πού θα πραγματοποιηθεί το δείπνο;",
        faq2answer: "Το δείπνο θα πραγματοποιηθεί στις <strong>20:30</strong>, μετά την τελετή και την ώρα κοκτέιλ.",
